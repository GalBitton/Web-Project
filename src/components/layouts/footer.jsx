...
const Footer = () => {
    ...
    return (
        <footer className="bg-white dark:bg-gray-800 text-black dark:text-white p-4 text-center flex justify-center items-center gap-2 border-t border-gray-300 dark:border-gray-700">
